...
cp -rpH freebsd/products/*.so "%buildroot/%{instdir}"
cp -rpH freebsd/products/*.jar "%buildroot/%{instdir}"
cp -rpH freebsd/products/lightzone "%buildroot/%{instdir}"
...
cp -rpH freebsd/products/lightzone.desktop "%buildroot/%{_datadir}/applications/"
cp -rpH freebsd/icons/LightZone_256x256.png "%buildroot/%{icondir}/256x256/apps/LightZone.png"
cp -rpH freebsd/icons/LightZone_128x128.png "%buildroot/%{icondir}/128x128/apps/LightZone.png"
cp -rpH freebsd/icons/LightZone_64x64.png "%buildroot/%{icondir}/64x64/apps/LightZone.png"
cp -rpH freebsd/icons/LightZone_48x48.png "%buildroot/%{icondir}/48x48/apps/LightZone.png"
cp -rpH freebsd/icons/LightZone_32x32.png "%buildroot/%{icondir}/32x32/apps/LightZone.png"
cp -rpH freebsd/icons/LightZone_16x16.png "%buildroot/%{icondir}/16x16/apps/LightZone.png"

install -d -m 755 %{buildroot}/%{_bindir}
install -m 755 freebsd/products/%{name} %{buildroot}/%{_bindir}
...
%files
%defattr(-,root,root)
%doc COPYING README.md freebsd/BUILD-FreeBSD.md
%dir %{instdir}
%{instdir}/*
%{_bindir}/%{name}
